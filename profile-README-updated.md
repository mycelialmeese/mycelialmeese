...
I'm a scientist-engineer with a background in **assay development and biotech** and an M.S. in Data Science. I work at the intersection of wet lab, instrumentation, and quantitative analysis — I like building things that actually work and figuring out why they don't.

Most of my professional work lives behind NDAs (LightDeck Diagnostics, SomaLogic), but this space showcases my machine learning coursework and personal projects.

## 🔬 Background
- **Assay Development** — aptamer-based assays, colorimetric detection, DNA hybridization, LFA platforms
- **Python** — pandas, NumPy, scikit-learn, OpenCV, TensorFlow/Keras, custom internal tooling
- **ML/Data Science** — deep learning, NLP, unsupervised learning, gradient boosting, statistical modeling
